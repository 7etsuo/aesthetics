...
## Image
![obs_0026](../../artifacts/studies/study_shadow_density_001/anchor_object_high.jpg)
...
| [vec_key_to_fill_ratio](../vectors/vec_key_to_fill_ratio.md) | 0.84 | 0.82 |
| [vec_source_hardness](../vectors/vec_source_hardness.md) | 0.72 | 0.78 |
...
## Unintended changes
- restaged to a hard window-like key
- new handle shadow on the napkin

## Notes
Intended shadow density high. Imagine relit the still life instead of only inking the darks.

...
## Image
![obs_0006](../../artifacts/studies/study_optical_softness_001/anchor_architecture_medium.jpg)

## Prompt
```
Preserve the same subject, identity, pose, framing, crop, camera position, and key-light direction. Do not change wardrobe, props, or scene content. Do not restyle the picture into a period look, a movie still, or a genre.  Change only optical softness. Set optical softness to: moderate vintage optical softness, slight highlight spread, natural fine-detail loss. Do not add grain, do not change color grade, do not change lighting ratio, and do not add colored highlight bleed.
```

## Vector scores
| vector_id | score | confidence |
|---|---:|---:|
| [vec_optical_softness](../vectors/vec_optical_softness.md) | 0.40 | 0.62 |
| [vec_edge_softness](../vectors/vec_edge_softness.md) | 0.40 | 0.70 |
| [vec_microcontrast](../vectors/vec_microcontrast.md) | 0.41 | 0.66 |
| [vec_diffusion](../vectors/vec_diffusion.md) | 0.21 | 0.55 |
...
| [vec_highlight_rolloff](../vectors/vec_highlight_rolloff.md) | 0.45 | 0.45 |

## Unintended changes
- none recorded

## Notes
Intended optical softness medium. Medium is only a small step from the anchor on most subjects.

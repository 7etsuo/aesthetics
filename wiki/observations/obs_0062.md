...
## Image
![obs_0062](../../artifacts/studies/study_edge_softness_001/anchor_architecture_low.jpg)

## Prompt
```
Preserve the same subject, identity, pose, framing, crop, camera position, and key-light direction. Do not change wardrobe, props, or scene content. Do not restyle the picture into a period look, a movie still, or a genre.  Change only edge softness. Set edge softness to: razor-hard contours, high acutance, no edge melt, tight subject outline. Change only edge width. Do not add a diffusion veil, do not spread highlight cores, do not add circular bokeh orbs, do not glow the eyes, do not change lighting, do not change time of day, do not add grain, and do not restyle into a genre.
```

## Vector scores
| vector_id | score | confidence |
|---|---:|---:|
| [vec_optical_softness](../vectors/vec_optical_softness.md) | 0.23 | 0.60 |
| [vec_edge_softness](../vectors/vec_edge_softness.md) | 0.12 | 0.62 |
| [vec_diffusion](../vectors/vec_diffusion.md) | 0.08 | 0.55 |
| [vec_bokeh_softness](../vectors/vec_bokeh_softness.md) | 0.10 | 0.50 |
| [vec_microcontrast](../vectors/vec_microcontrast.md) | 0.59 | 0.50 |
